package com.epam.health_tool.aspect;

import com.epam.health_tool.security.BaseSecurityContextHandler;
...
public class HttpSecurityAspect extends BaseSecurityContextHandler {
    @Pointcut("execution(* com.epam.health_tool.util.HttpCommonUtil.createHttpClientBuilder())")
    public void addHttpClientBuilderSecurity() {
    }

    @Pointcut("execution(* com.epam.health_tool.util.HttpCommonUtil.createRequestBuilder(..))")
    public void addHttpRequestBuilderSecurity() {
    }

    @Pointcut("execution(* com.epam.health_tool.util.HttpCommonUtil.createHttpUriRequest(..))")
